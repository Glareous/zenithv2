...
interface ResetPasswordBasicProps {
  token?: string
}

const ResetPasswordBasic: React.FC<ResetPasswordBasicProps> = ({ token }) => {
  ...
  const resetPasswordMutation = api.auth.resetPassword.useMutation({
    onSuccess: () => {
      ...
      router.push('/auth/successful-password-basic')
    },
    onError: (error) => {
                ...
                <div className="grid grid-cols-12 gap-4 mt-5">
                  ...
                  <div className="col-span-12">
                    <button
                      ...
                      className="w-full px-4 py-2 text-white rounded-md bg-primary-500 hover:bg-primary-600 disabled:opacity-50 disabled:cursor-not-allowed">
