...
const NimFraudChat: NextPageWithLayout = () => {
  ...
  if (status === 'loading') {
    return (
      <React.Fragment>
        <BreadCrumb title="NIM Fraud Chat" subTitle="Fraud Detection Assistant" />
        <div className="card">
        ...
        <div className="card">
          <div className="card-body">
            <div className="text-center text-gray-500 dark:text-dark-500">
              <p>Please login to access the NIM Fraud chat.</p>
  ...
  return (
    <React.Fragment>
      ...
      <div className="grid grid-cols-12 gap-x-space">
        {/* NO Employee Menu for NIM Fraud - direct chat with agent */}
